...
module.exports.Responsive = __webpack_require__(32).default;
module.exports.Responsive.utils = __webpack_require__(15);
module.exports.WidthProvider = __webpack_require__(33).default;
...
var _GridItem = __webpack_require__(23);
...
var _reactDraggable = __webpack_require__(24);

var _reactResizable = __webpack_require__(28);
...
*/
var aa=__webpack_require__(0),n=__webpack_require__(9),r=__webpack_require__(26);function u(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(u(227));
...
module.exports.Resizable = __webpack_require__(14).default;
module.exports.ResizableBox = __webpack_require__(31).default;
...
var _Resizable = _interopRequireDefault(__webpack_require__(14));
...
var _responsiveUtils = __webpack_require__(15);

var _ReactGridLayout = __webpack_require__(10);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "ToolboxLayout", function() { return /* reexport */ App_ToolboxLayout; });
__webpack_require__.d(__webpack_exports__, "AppTest", function() { return /* reexport */ src_AppTest; });
__webpack_require__.d(__webpack_exports__, "ReactGridLayout", function() { return /* reexport */ src_ReactGridLayout; });
...
var react_grid_layout = __webpack_require__(8);

// CONCATENATED MODULE: ./src/ReactGridLayout.js
...
var ResponsiveReactGridLayout = Object(react_grid_layout["WidthProvider"])(react_grid_layout["Responsive"]);

var ReactGridLayout_ReactGridLayout = /*#__PURE__*/function (_React$Component) {
  _inherits(ReactGridLayout, _React$Component);
  ...
  function ReactGridLayout(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onLayoutChange", function (layout, layouts) {
      ...
      _this.props.updateLayouts(layouts);
    });
  ...
  _createClass(ReactGridLayout, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          compactType = _this$props.compactType;
      return /*#__PURE__*/react_default.a.createElement("div", null, /*#__PURE__*/react_default.a.createElement(ResponsiveReactGridLayout, _extends({}, this.props, {
        layouts: layouts,
...
_defineProperty(ReactGridLayout_ReactGridLayout, "defaultProps", {
  className: 'layout',
  rowHeight: 30,
...
/* harmony default export */ var src_ReactGridLayout = (ReactGridLayout_ReactGridLayout);
...
var App_ToolboxLayout = /*#__PURE__*/function (_React$Component) {
  App_inherits(ToolboxLayout, _React$Component);

  var _super = App_createSuper(ToolboxLayout);

  function ToolboxLayout(props) {
    var _this;

    App_classCallCheck(this, ToolboxLayout);

    _this = _super.call(this, props);

    App_defineProperty(App_assertThisInitialized(_this), "updateLayouts", function (layouts) {
      _this.setState({
        layouts: layouts
      });
    });

    App_defineProperty(App_assertThisInitialized(_this), "onBreakpointChange", function (breakpoint) {
  ...
  App_createClass(ToolboxLayout, [{
    ...
    value: function generateDOM() {
      return lodash_default.a.map(this.state.layouts[this.state.currentBreakpoint], function (l) {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react_default.a.createElement(react_default.a.Fragment, null, /*#__PURE__*/react_default.a.createElement("div", null, "HELLO 2222"), /*#__PURE__*/react_default.a.createElement(src_ReactGridLayout, newProps, this.generateDOM()));
    }
  }]);
...
function generateLayout() {
  return lodash_default.a.map(lodash_default.a.range(0, 25), function (item, idx) {
    var y = Math.ceil(Math.random() * 4) + 1;
    return {
      x: lodash_default.a.random(0, 5) * 2 % 12,
...
// CONCATENATED MODULE: ./src/AppTest.js
function AppTest_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { AppTest_typeof = function _typeof(obj) { return typeof obj; }; } else { AppTest_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return AppTest_typeof(obj); }

function AppTest_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function AppTest_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function AppTest_createClass(Constructor, protoProps, staticProps) { if (protoProps) AppTest_defineProperties(Constructor.prototype, protoProps); if (staticProps) AppTest_defineProperties(Constructor, staticProps); return Constructor; }

function AppTest_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) AppTest_setPrototypeOf(subClass, superClass); }

function AppTest_setPrototypeOf(o, p) { AppTest_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return AppTest_setPrototypeOf(o, p); }

function AppTest_createSuper(Derived) { return function () { var Super = AppTest_getPrototypeOf(Derived), result; if (AppTest_isNativeReflectConstruct()) { var NewTarget = AppTest_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return AppTest_possibleConstructorReturn(this, result); }; }

function AppTest_possibleConstructorReturn(self, call) { if (call && (AppTest_typeof(call) === "object" || typeof call === "function")) { return call; } return AppTest_assertThisInitialized(self); }

function AppTest_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function AppTest_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }

function AppTest_getPrototypeOf(o) { AppTest_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return AppTest_getPrototypeOf(o); }
...
var AppTest_AppTest = /*#__PURE__*/function (_React$Component) {
  AppTest_inherits(AppTest, _React$Component);

  var _super = AppTest_createSuper(AppTest);

  function AppTest() {
    AppTest_classCallCheck(this, AppTest);

    return _super.apply(this, arguments);
  }

  AppTest_createClass(AppTest, [{
    key: "render",
    value: function render() {
      return /*#__PURE__*/react_default.a.createElement(react_default.a.Fragment, null, /*#__PURE__*/react_default.a.createElement("div", null, "HELLO 3333333333333333333333"));
    }
  }]);
...
/* harmony default export */ var src_AppTest = (AppTest_AppTest);
// CONCATENATED MODULE: ./src/index.js
// import React from 'react';
// import ReactDOM from 'react-dom';
// // import './index.css';
// import ToolboxLayout from './App';
